      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl overflow-hidden shadow-sm dark:shadow-none">
        ...
        <div className="px-4 pt-3 pb-3 flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                {totalReceived > 0 && (
                  <span className="text-xs font-medium text-green-600 dark:text-green-400">
                    +${totalReceived.toLocaleString(undefined, { maximumFractionDigits: 0 })} received
                  </span>
                )}
              </div>
            </div>
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-green-600 hover:bg-green-500 active:bg-green-700 text-white text-xs font-medium px-3 py-1.5 rounded-lg transition-colors flex-shrink-0"
          >
        ...
        {/* Eligibility Tracker + History — collapsible */}
        {expanded && (
          <>
            <div className="border-t border-gray-100 dark:border-gray-800" />

            {/* Eligibility Tracker */}
            <div className="mx-4 mb-4 mt-3 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 px-3 py-3 space-y-2.5">
                  ...
                  <div key={p.id} className="px-4 py-3">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex flex-col items-end gap-2 flex-shrink-0">
                        ...
                        <button
                          onClick={() => { if (confirm(`Delete Payout #${p.number}?`)) deletePayout(p.id); }}

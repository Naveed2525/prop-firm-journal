...
export function PersonalRuleCard({ rule, compact = false, editable = false, onSave, onDelete }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl p-5 shadow-md border-2 border-amber-500 bg-gradient-to-br from-amber-300 via-amber-400 to-amber-500 dark:from-amber-600 dark:via-amber-700 dark:to-amber-800">
